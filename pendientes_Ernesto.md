...
- [~] Sala de mando operativa debería mostrar los valores registrados en la bitácora operación 24hr y disponibilidad, para las bitácoras de jdt e ing de operación. (para jdt e ing de op, si cualquiera de los 2 crea, se envía a ambas) → [REQ-02](./docs/requerimientos/REQ-02-reflejo-bitacoras-sala.md) — **Operación 24h ✅ (D-058); falta Disponibilidad** (ADR propio)
...
| [REQ-02](./docs/requerimientos/REQ-02-reflejo-bitacoras-sala.md) — Reflejo a bitácoras de Sala | 🟢 **Operación 24h implementado** (D-058, 2026-07-27) · falta **Disponibilidad** (ADR propio; sus tipos espejo ya están sembrados) | REQ-03 ✅ |
