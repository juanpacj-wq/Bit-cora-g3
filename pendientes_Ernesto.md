...
- [ ] cuando cambia despacho (redesp<>desp por correo o registro) crear histórico en op24hr con el formato en la imagen → [REQ-05](./docs/requerimientos/REQ-05-asiento-cambio-despacho.md) — **reformulado 2026-08-31**: el redespacho tecleado ya funciona (D-058 + D-063) y el correo del CND queda fuera; lo que falta es asentar la llegada del **despacho del día siguiente** de XM. Listo para planificar.
...
| [REQ-05](./docs/requerimientos/REQ-05-asiento-cambio-despacho.md) — Asiento del despacho del día siguiente | 🟢 **Listo para planificar** (desbloqueado 2026-08-31; el redespacho tecleado ya salió en D-058/D-063) | REQ-02 ✅, REQ-04 ✅, REQ-06 ✅ |
