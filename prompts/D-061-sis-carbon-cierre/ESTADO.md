...
| — | GATE-O2 | 632/632 en verde y 0 skips, 0 violaciones, D7–D10, L09 y L10 nuevos | ✅ (visto bueno pendiente) | | `GATE-O2.md` |
| — | Backfill prod | Corrida contra `PortalG3` (integrador, con visto bueno) | ⬜ pendiente del usuario | | `GATE-O2.md` §5 D10 |
| O3 | L09 | El refetch preservado no puede convertirse en un borrado al guardar (front) | ⬜ | — | — |
| O3 | L10 | Endurecer el descubrimiento del SIS y la cobertura del scrape manual | ⬜ | — | — |
| — | GATE-O3 | | ⬜ | | `GATE-O3.md` |
