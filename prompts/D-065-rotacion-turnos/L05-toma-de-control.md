...
(3115) y C5 quedan tal cual. Lo que sí te toca de los hechos de abajo: el punto 7 (`grupo` de
`rotacion_cumplimiento` sin CHECK, por si lo lees), el 8 (las FK van **sin nombre**: captura la
violación por número de error 547, no por nombre) y el 10 (las tablas existen y están vacías en
`PortalG3_dev`).
